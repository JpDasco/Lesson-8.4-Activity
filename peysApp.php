...
<body>
	...
	<form method="get">
		...
		<input type="range" name="imgSize" id="imgSize" value="60" min="10" max="100" step="10"><br>
	...
	<img src="myPhoto.jpg" style="width: <?php echo $imgSize . '%'; ?>;border-color: <?php echo $color; ?>;border-width: 3px; border-style: solid;">
	</form>
</body>
</html>
